	...
	<body>
		...
		<div id="show-task" class="content scaffold-show" role="main">
			...
			<ol class="property-list task">
				...
				<g:if test="${taskInstance?.createdOn}">
				<li class="fieldcontain">
					<span id="createdOn-label" class="property-label"><g:message code="task.createdOn.label" default="Created On" /></span>
					
						<span class="property-value" aria-labelledby="createdOn-label"><g:formatDate date="${taskInstance?.createdOn}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${taskInstance?.updatedOn}">
				<li class="fieldcontain">
					<span id="updatedOn-label" class="property-label"><g:message code="task.updatedOn.label" default="Updated On" /></span>
					
						<span class="property-value" aria-labelledby="updatedOn-label"><g:formatDate date="${taskInstance?.updatedOn}" /></span>
				...
				<g:if test="${taskInstance?.amount}">
				<li class="fieldcontain">
					<span id="amount-label" class="property-label"><g:message code="task.amount.label" default="Amount" /></span>
					
						<span class="property-value" aria-labelledby="amount-label"><g:fieldValue bean="${taskInstance}" field="amount"/></span>
